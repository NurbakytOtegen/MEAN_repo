...
@Component({
  ...
  template: `
    <h2 mat-dialog-title>Редактировать автомобиль</h2>
...
export class EditCarDialogComponent {
  ...
  constructor(
    ...
    this.carForm = this.fb.group({
      ...
      year: [data.year, [Validators.required, Validators.min(1900), Validators.max(this.currentYear + 1)]],
      price: [data.price, [Validators.required, Validators.min(0)]],
      mileage: [data.mileage, [Validators.required, Validators.min(0)]],
      transmission: [data.transmission, Validators.required],
      engine_vol: [data.engine_vol, [Validators.required, Validators.min(0)]],
